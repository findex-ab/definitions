...
export declare const InviteSchema: ss.Struct<{
    ...
    user: ss.Struct<{
        ...
        authenticationMethod: ss.Struct<import("./auth").EAuthenticationMethod | undefined, {
            ...
            GOOGLE: import("./auth").EAuthenticationMethod.GOOGLE;
        }>;
        ...
        klaviyoId: ss.Struct<string | undefined, null>;
        personalReferralCode: ss.Struct<string | undefined, null>;
        opportunities: ss.Struct<{
            enabled?: boolean | undefined;
            enabledAt?: string | undefined;
        } | undefined, {
            enabled: ss.Struct<boolean | undefined, null>;
            enabledAt: ss.Struct<string | undefined, null>;
        }>;
        diversificationViewMode: ss.Struct<import("./user").EDiversificationViewMode | undefined, {
            DONUT: import("./user").EDiversificationViewMode.DONUT;
            TREE: import("./user").EDiversificationViewMode.TREE;
        }>;
        newsViewMode: ss.Struct<import("./user").ENewsViewMode | undefined, {
    ...
    sender: ss.Struct<TDocRef<IUser, import("./documentId").DocumentId> | undefined, {
        ...
        diversificationViewMode?: ss.Describe<import("./user").EDiversificationViewMode | undefined> | undefined;
        newsViewMode?: ss.Describe<import("./user").ENewsViewMode | undefined> | undefined;
    } | null>;
    asset: ss.Struct<TDocRef<IAsset, import("./documentId").DocumentId> | undefined, {
        ...
        enabledWidgets?: ss.Describe<import("./asset").EAssetWidget[] | undefined> | undefined;
    ...
    type: ss.Struct<EInviteType.REFERRAL | EInviteType.ASSET_OWNER | EInviteType.ASSET_ADMIN | EInviteType.SHAREHOLDER | EInviteType.GENERIC_USER, {
        REFERRAL: EInviteType.REFERRAL;
