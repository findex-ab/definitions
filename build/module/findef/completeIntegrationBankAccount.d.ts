...
import { ICompleteRawIntegrationBankAccount } from "./completeRawIntegrationBankAccount";
...
export type ICompleteIntegrationBankAccount = {
    ...
    raw?: ICompleteRawIntegrationBankAccount;
    account?: {
        providerAccountId: string;
        providerAccountNumber: string;
        name: string;
    ...
    positions?: Array<ICompleteIntegrationPosition>;
    pctPerformance?: {
        today?: number;
        ytd?: number;
        max?: number;
    ...
    accountCreated?: string;
    interestRate?: number;
    loanParts?: Array<IIntegrationLoanPart>;
    isOwner?: boolean;
    providerAccountCreated?: string;
};
