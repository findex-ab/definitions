...
export declare enum ENewsViewMode {
    GRID = "GRID",
    LIST = "LIST"
}
...
export declare const UserSchema: ss.Struct<{
    ...
    authenticationMethod: ss.Struct<EAuthenticationMethod | undefined, {
        ...
        GOOGLE: EAuthenticationMethod.GOOGLE;
    }>;
    ...
    featurebaseIdentity: ss.Struct<string | undefined, null>;
    ...
    diversificationViewMode: ss.Struct<EDiversificationViewMode | undefined, {
        DONUT: EDiversificationViewMode.DONUT;
        TREE: EDiversificationViewMode.TREE;
    }>;
    newsViewMode: ss.Struct<ENewsViewMode | undefined, {
